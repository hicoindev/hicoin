...
{
    columns << QString() << tr("Date") << tr("Type") << tr("Address") << tr("Description") << tr("Amount");
...
QString TransactionTableModel::formatDescription(const TransactionRecord *wtx) const
{
